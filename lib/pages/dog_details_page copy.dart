...
class _DogDetailsPageState extends State<DogDetailsPage> {
  ...
  String? newHeroUrl; // ✅ FIXES YOUR CRASH
  ...
  *,
  ...
  if (dogResult == null) {
  debugPrint("❌ dog not found: ${widget.dogId}");
  return;
  }

  // ✅ RESTORED CORRECTLY
  breeder = dogResult['breeder'];
  owner = dogResult['owner'];

  // 🔥 HERO IMAGE (UNCHANGED — JUST FIXED VARIABLE)
